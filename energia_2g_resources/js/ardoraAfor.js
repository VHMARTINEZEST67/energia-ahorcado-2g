...
$("#ardoraQuest").html("<img id='playSound' class='imaLeft' src='energia_2g_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
...
showButtonNext();}}}}
function paintLetters(){profG=profG+76; var leV=0;var toV=profG;for (i = 0; i < fillLetter.length; i++) {
...
leV=leV+47;if (leV+47>actMaxWidth){leV=0;toV=toV+47;}}
var heiAct=(toV+47).toString()+"px";$("#ardoraAct").css("height",heiAct);
